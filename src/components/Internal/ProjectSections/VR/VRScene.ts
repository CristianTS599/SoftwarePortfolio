...
export function InitVRScene(canvas: HTMLCanvasElement) {
  ...
  const planetTexture = new THREE.TextureLoader().load(
    "/ProjectImgs/VR/planettextures/red1.jpg"
  )
  ...
  const planet2 = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "/ProjectImgs/VR/planettextures/forest.jpg"
      ),
    })
  )
  ...
  const planet3 = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "/ProjectImgs/VR/planettextures/purple1.jpg"
      ),
    })
  )
  ...
  const planet4 = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "/ProjectImgs/VR/planettextures/blue1.jpg"
      ),
    })
  )
  ...
  const planet5 = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "/ProjectImgs/VR/planettextures/green1.jpg"
      ),
    })
  )
  ...
  const planet6 = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "/ProjectImgs/VR/planettextures/brown1.webp"
      ),
    })
  )
  ...
  const planet7 = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "/ProjectImgs/VR/planettextures/red2.jpg"
      ),
    })
  )
