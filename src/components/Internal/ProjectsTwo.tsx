...
export default function ProjectsTwo() {
  return (
    <>
      <div>
        <Card className="mx-5 mt-5 w-full">
          <CardHeader>
            <CardDescription>This is a test desctiption</CardDescription>
          ...
          <CardContent className="flex flex-col gap-3">
            <Accordion
              ...
              type="single"
              collapsible
              className="max-h-120 flex-1 flex-col overflow-x-auto rounded-lg border"
              defaultValue="Test"
            >
              <AccordionItem
